...
INSERT INTO `cste_group` (`gid`, `group_name`, `valid_for_days`) VALUES
(1, 'Free', , 0),
(3, 'Premium-1',  90),
(4, 'Premium-2',  120);
...
INSERT INTO `cste_quiz` (`quid`, `quiz_name`, `description`, `start_date`, `end_date`, `gids`, `qids`, `noq`, `correct_score`, `incorrect_score`, `ip_address`, `duration`, `maximum_attempts`, `pass_percentage`, `view_answer`, `camera_req`, `question_selection`, `gen_certificate`, `certificate_text`) VALUES
...
--
-- Indexes for table `cste_answers`
--
ALTER TABLE `cste_answers`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `cste_category`
--
ALTER TABLE `cste_category`
  ADD PRIMARY KEY (`cid`);

--
-- Indexes for table `cste_group`
--
ALTER TABLE `cste_group`
  ADD PRIMARY KEY (`gid`);

--
-- Indexes for table `cste_level`
--
ALTER TABLE `cste_level`
  ADD PRIMARY KEY (`lid`);

--
-- Indexes for table `cste_options`
--
ALTER TABLE `cste_options`
  ADD PRIMARY KEY (`oid`);

--
-- Indexes for table `cste_payment`
--
ALTER TABLE `cste_payment`
  ADD PRIMARY KEY (`pid`);

--
-- Indexes for table `cste_qbank`
--
ALTER TABLE `cste_qbank`
  ADD PRIMARY KEY (`qid`);

--
-- Indexes for table `cste_qcl`
--
ALTER TABLE `cste_qcl`
  ADD PRIMARY KEY (`qcl_id`);

--
-- Indexes for table `cste_quiz`
--
ALTER TABLE `cste_quiz`
  ADD PRIMARY KEY (`quid`);

--
-- Indexes for table `cste_result`
--
ALTER TABLE `cste_result`
  ADD PRIMARY KEY (`rid`);

--
-- Indexes for table `cste_users`
--
ALTER TABLE `cste_users`
  ADD PRIMARY KEY (`uid`);
...
--
-- AUTO_INCREMENT for table `cste_answers`
--
ALTER TABLE `cste_answers`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
--
-- AUTO_INCREMENT for table `cste_category`
--
ALTER TABLE `cste_category`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `cste_group`
--
ALTER TABLE `cste_group`
  MODIFY `gid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `cste_level`
--
ALTER TABLE `cste_level`
  MODIFY `lid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `cste_options`
--
ALTER TABLE `cste_options`
  MODIFY `oid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `cste_payment`
--
ALTER TABLE `cste_payment`
  MODIFY `pid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cste_qbank`
--
ALTER TABLE `cste_qbank`
  MODIFY `qid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `cste_qcl`
--
ALTER TABLE `cste_qcl`
  MODIFY `qcl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
--
-- AUTO_INCREMENT for table `cste_quiz`
--
ALTER TABLE `cste_quiz`
  MODIFY `quid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `cste_result`
--
ALTER TABLE `cste_result`
  MODIFY `rid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `cste_users`
--
ALTER TABLE `cste_users`
  MODIFY `uid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

ALTER TABLE `cste_quiz` ADD `with_login` INT NOT NULL DEFAULT '1' AFTER `certificate_text`;

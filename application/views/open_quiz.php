...
?>
                    <div style="margin-top:30px;">
                        <label>
                            <a href="<?php echo site_url('quiz/quiz_detail/'.$val['quid'].'/'.urlencode($val['quiz_name'])); ?>">
                                <?php echo $val['quiz_name'];?>
                            </a>
                        </label>
...
<?php echo substr(strip_tags($val['description']),0,100);?>
                            ...
                            <?php echo $this->lang->line('questions');?>:
                                <?php echo $val['noq'];?> |
                                    <?php echo $this->lang->line('duration2');?>
                                        <?php echo $val['duration'];?> Min.
                        </p>
                    </div>
                    <?php 
}

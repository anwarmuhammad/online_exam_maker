...
<a href="<?php echo site_url('quiz/edit_quiz/'.$val['quid']);?>" class="btn btn-gray btn-small"><i class="icon-edit"></i> Edit</a>

<a href="javascript:remove_entry('quiz/remove_quiz/<?php echo $val['quid'];?>');" class="btn btn-red btn-small" ><i class="icon-trash"></i> Delete</a>
...
<a href="<?php echo site_url('quiz/index/'.$back.'/'.$list_view);?>"  class="btn btn-gray"><?php echo $this->lang->line('back');?></a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('quiz/index/'.$next.'/'.$list_view);?>"  class="btn btn-gray"><?php echo $this->lang->line('next');?></a>

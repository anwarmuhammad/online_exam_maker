...
<?php echo $result['last_name'];?>!</span>  <?php echo str_replace('{attempt_no}',ordinal($attempt),$this->lang->line('title_result'));?> </h3></center>
                    ...
                    <div class="col-lg-12" style="margin-top:20px;">
                        ...
                        <div class="col-lg-2" style="text-align:center;">
                            ...
                            <p style="color:#e39500;">
                                <?php echo secintomin($result['total_time']);?> Min.</p>

                        </div>
                        <div class="col-lg-2" style="text-align:center;">
                            <p>
                                <?php echo $this->lang->line('attempt_time');?>
                            </p>
                            <p style="color:#e39500;font-size:14px;">
                                <?php echo date('Y-m-d H:i:s',$result['start_time']);?>
                            </p>
                        ...
                        <div class="col-lg-2" style="text-align:center;">
                            ...
                            <p style="color:#e39500;">
                                <?php echo $result['percentage_obtained'];?>%</p>
...
?>
                    ...
                    <div class="col-lg-12" style="margin-top:50px;color:#dddddd;font-size:14px;">
                        ...
                        <center>
                            <?php echo $this->lang->line('result_id');?>
                                <?php echo $result['rid'];?> &nbsp;&nbsp;&nbsp;
...
if($result['camera_req']=='1'){
	?>
                                    <tr>
                                        <td colspan='2'>
                                            <?php if($result['photo']!=''){ ?> <img src="<?php echo base_url('photo/'.$result['photo']);?>" id="photograph">
                                                <?php } ?>
                                        </td>
                                    </tr>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo secintomin($result['total_time']);?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $result['percentage_obtained'];?>%</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('percentile_obtained');?>
                                            ...
                                            <td>
                                                <?php echo substr(((($percentile[1]+1)/$percentile[0])*100),0,5);   ?>%</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('score_obtained');?>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background:#337ab7;color:#ffffff;">
                                        <?php echo $this->lang->line('incorrect');?>
                                    </th>
                                    <th style="background:#337ab7;color:#ffffff;">
                                        <?php echo $this->lang->line('notattempted');?>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
					  ...
					  if(isset($cia_cat[1][$vk])){ $no_iC=$cia_cat[1][$vk]; $incorrect+=$cia_cat[1][$vk]; }else{ $no_iC=0;  }
						?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo (($no_C*$result['correct_score'])+($no_iC*$result['incorrect_score']));?>
                                        </td>
                                        <td>
                                            <?php echo secintomin($cia_tim_cate[0][$vk]+$cia_tim_cate[1][$vk]+$cia_tim_cate[2][$vk]);?> Min.</td>
                                        <td>
                                            <?php echo $no_C;?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php   if(isset($cia_cat[2][$vk])){ echo $cia_cat[2][$vk]; $notattempted+=$cia_cat[2][$vk]; }else{ echo '0';  } ?>
                                        </td>
                    ...
                    <div class="col-lg-12 noprint" style="margin-top:50px;">
                        <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                            <?php echo $this->lang->line('rank').': '.$rank;?>
                        </button>
  ...
  if($rank > 3 ){
  ?>
                                <div class="circle_ur s_title" data-toggle="tooltip" title="Your Rank" style="margin-left:<?php echo intval(($rank/$last_rank)*100);?>%">
                                    <?php echo $rank;?>
                                </div>
                                <?php 
  }
  ...
  if($rank != $last_rank ){
  ?>
                                        <div class="circle_l s_title" data-toggle="tooltip" title="Last Rank">
                                            <?php echo $last_rank;?>
                                        </div>
                                        <?php 
  }else{
  ?>
                                            <div class="circle_l s_title" data-toggle="tooltip" title="Your Rank is Last">
                                                <?php echo $last_rank;?>
                                            </div>
  ...
  ?>
                    ...
                    <div class="col-lg-12 noprint" style="margin-top:50px;">
                        <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                            <?php echo $this->lang->line('score_obtained').': '.$result['score_obtained'];?>
                        </button>
                        <div class="td_line" style="float:left;width:700px;height:70px;">
                            <div <?php if($rank=='1' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?>>
                                        <?php echo $toppers[0]['score_obtained'];?>
                            </div>
                            <div <?php if($rank=='2' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?>>
                                        <?php echo $toppers[1]['score_obtained'];?>
                            </div>
                            <div <?php if($rank=='3' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?>>
                                        <?php echo $toppers[2]['score_obtained'];?>
                            </div>
                            <?php 
  if($rank > 3 ){
  ?>
                                <div class="circle_ur s_title" data-toggle="tooltip" title="Your Score" style="margin-left:<?php echo intval(($rank/$last_rank)*100);?>%">
                                    <?php echo $result['score_obtained'];?>
                                </div>
                                <?php 
  }
  ...
  if($rank != $last_rank ){
  ?>
                                        <div class="circle_l s_title" data-toggle="tooltip" title="Lowest Score">
                                            <?php echo $looser['score_obtained'];?>
                                        </div>
                                        <?php 
  }else{
  ?>
                                            <div class="circle_l s_title" data-toggle="tooltip" title="Lowest Score is Your">
                                                <?php echo $looser['score_obtained'];?>
                                            </div>
  ...
  ?>
                    ...
                    <div class="col-lg-12 noprint" style="margin-top:50px;margin-bottom:50px;">
                        <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                            <?php echo $this->lang->line('time').': '.secintomin($result['total_time']).' Min.';?>
                        </button>
                        <div class="td_line" style="float:left;width:700px;height:70px;">
                            <div <?php if($rank=='1' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?> style="font-size:12px;padding-top:10px;">
                                        <?php echo secintomin($toppers[0]['total_time']);?>
                            </div>
                            <div <?php if($rank=='2' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?> style="font-size:12px;padding-top:10px;">
                                        <?php echo secintomin($toppers[1]['total_time']);?>
                            </div>
                            <div <?php if($rank=='3' ){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                                <?php }else{ ?>class="circle_result"
                                    <?php } ?> style="font-size:12px;padding-top:10px;">
                                        <?php echo secintomin($toppers[2]['total_time']);?>
                            </div>
                            <?php 
  if($rank > 3 ){
  ?>
                                <div class="circle_ur s_title" data-toggle="tooltip" title="Your Time" style="margin-left:<?php echo intval(($rank/$last_rank)*100);?>%" style="font-size:12px;padding-top:10px;">
                                    <?php echo secintomin($result['total_time']);?>
                                </div>
                                <?php 
  }
  ...
  if($rank != $last_rank ){
  ?>
                                        <div class="circle_l s_title" data-toggle="tooltip" title="Last Ranker's Time" style="font-size:12px;padding-top:10px;">
                                            <?php echo secintomin($looser['total_time']);?>
                                        </div>
                                        <?php 
  }else{
  ?>
                            ...
                            <script type="text/javascript">
                                ...
                                function drawChart() {
                                    ...
                                    var options = {
                                        ...
                                        top_10_result ');?> <?php echo $result['
                                        quiz_name '];?>',
                                        hAxis: {
                                            title: '<?php echo $this->lang->line('
                                            quiz ');?>(<?php echo $this->lang->line('
                                            user ');?>)',
                                            titleTextStyle: {
                                                color: 'red'
                                            }
                                                                                                                        ...
                                                                                                                        <div class="op">
                                                                                                                            <table>
                                                                                                                                <tr>
                                                                                                                                    <td></td>
                                                                                                                                    <td>
                                                                                                                                        <?php echo "<b>".$this->lang->line('your_answer').'</b> ';?></td>
                                                                                                                                    <td>
                                                                                                                                        <?php echo "<b>".$this->lang->line('correct_answer').'</b> ';?></td>
                                                                                                                                </tr>
                                                                                                                                <?php 

...
?>
<a href="<?php echo site_url('qbank/edit_question_'.$qn.'/'.$val['qid']);?>"class="btn btn-gray btn-small"><i class="icon-edit"></i>Edit</a>

<a href="javascript:remove_entry('qbank/remove_question/<?php echo $val['qid'];?>');" class="btn btn-red btn-small"> 
...
<a href="<?php echo site_url('qbank/index/'.$back.'/'.$cid.'/'.$lid);?>"  class="btn btn-gray"><?php echo $this->lang->line('back');?></a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('qbank/index/'.$next.'/'.$cid.'/'.$lid);?>"  class="btn btn-gray"><?php echo $this->lang->line('next');?></a>
...
<?php echo $this->lang->line('upload_excel');?>
	...
	<input type="submit" value="Import" style="margin-top:5px;" class="btn btn-gray">

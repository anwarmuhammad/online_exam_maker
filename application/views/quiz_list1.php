 ...
 <br>
  <div class="col-lg-6 ">
    <form class="text-center" method="post" action="<?php echo site_url('quiz/index/0/'.$list_view);?>">
...
<td>
<a data-toggle="modal" href="<?php echo site_url('quiz/quiz_detail/'.$val['quid']);?>" class="btn btn-success btn-small"><i class=""></i>Attempt </a>



<a data-toggle="modal" href="<?php echo site_url('quiz/edit_quiz/'.$val['quid']);?>" class="btn btn-red btn-small"><i class="icon-trash"></i> Edit</a>

<a data-toggle="modal" href="javascript:remove_entry('quiz/remove_quiz/<?php echo $val['quid'];?>');" class="btn btn-red btn-small"><i class="icon-trash"></i> Delete</a>
